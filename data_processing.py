...
def read_data(data_file):
    ...
    df = pd.concat([df, df1, df2, df3, df4, df5, df6, df7, df8, df9, df10])
...
def feature_importance(df):
    ...
    removed = ['hitdatahistorymkey', 'filename', 'linenumber', 'visitoridhigh', 'visitoridlow', 'hit_time_gmt',
               ...
               'lastpurchasetimegmt', 'updatedloaddate', 'initialloaddate']#, 'productlist', 'eventlist']
    ...
    x_train, x_test, y_train, y_test = train_test_split(df_third_subset.iloc[:,:], 
                                                        ...
                                                        test_size=0.20, random_state=148)
